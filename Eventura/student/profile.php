...
try {
    ...
    // Get statistics
    $stmt = $pdo->prepare("SELECT COUNT(*) as total_events FROM event_registrations WHERE user_id = ?");
    $stmt->execute([$user_id]);
    $stats['total_events'] = $stmt->fetchColumn();
    
    $stmt = $pdo->prepare("SELECT COUNT(*) as attended_events FROM event_registrations WHERE user_id = ? AND status = 'attended'");
    $stmt->execute([$user_id]);
    $stats['attended_events'] = $stmt->fetchColumn();
    
    $stmt = $pdo->prepare("SELECT COUNT(*) as upcoming_events FROM event_registrations er 
    ...
    $profile = [];
    $stats = ['total_events' => 0, 'attended_events' => 0, 'upcoming_events' => 0];
}
    ...
    if (!verifyCSRFToken($csrf_token)) {
        ...
        try {
            ...
            if ($profile_exists) {
                ...
                $stmt = $pdo->prepare("UPDATE student_profiles SET phone = ?, department = ? WHERE user_id = ?");
                $stmt->execute([$phone, $department, $user_id]);
            } else {
        ...
        <div class="profile-container">
            <div class="profile-header">
                <div class="profile-header-content">
                    ...
                    <div class="profile-info-main">
                        <h1 class="profile-name"><?php echo $profile['full_name'] ?? 'Student'; ?></h1>
                        <p class="profile-email"><?php echo $profile['email'] ?? ''; ?></p>
                        <span class="profile-badge">
                            <i class="fas fa-graduation-cap"></i> <?php echo ucfirst($profile['role'] ?? 'Student'); ?>
                        </span>
                    </div>
            ...
            <div class="profile-details">
                <div class="details-section">
                    ...
                    <?php if ($profile && $profile['student_id']): ?>
                        <div class="detail-item">
                            <span class="detail-label">
                                <i class="fas fa-id-badge"></i> Student ID
                            </span>
                            <span class="detail-value"><?php echo $profile['student_id']; ?></span>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo $profile['roll_no']; ?></span>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo $profile['phone'] ?? 'Not provided'; ?></span>
                        </div>
                    <?php else: ?>
                ...
                <div class="details-section">
                    ...
                    <?php if ($profile && $profile['course']): ?>
                        <div class="detail-item">
                            <span class="detail-label">
                                <i class="fas fa-book"></i> Course
                            </span>
                            <span class="detail-value"><?php echo $profile['course']; ?></span>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value"><?php echo $profile['year'] ? getOrdinalSuffix($profile['year']) . ' Year' : 'Not specified'; ?></span>
                        </div>
